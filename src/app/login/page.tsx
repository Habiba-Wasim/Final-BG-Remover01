...
// /app/login/page.tsx
// "use client"
// import { auth, googleProvider, fbProvider } from "@/lib/firebase"
...
//       <button onClick={loginEmail} className="bg-blue-500 text-white px-4 py-2 rounded">Login with Email</button>
//       <button onClick={loginGoogle} className="bg-red-500 text-white px-4 py-2 rounded">Google</button>
//       <button onClick={loginFB} className="bg-blue-700 text-white px-4 py-2 rounded">Facebook</button>
//     </div>
//   )
// }
